...
const SEED_ADMINS = [
  ...
  { matricola: "50270", pin: "5027", nome: "Ciro",            ruolo: "Sviluppatore & Admin", ts: Date.now() },
];
...
const C = {
  ...
  borderHi:  "#243552",
  accent:    "#f4821f",
  accentGlow:"rgba(244,130,31,0.20)",
  danger:    "#e53e3e",
  dangerDim: "rgba(229,62,62,0.15)",
  success:   "#38a169",
...
// ── HELPERS ───────────────────────────────────────────────────────
const ytId  = u => { if (!u) return null; const m = u.match(/(?:youtu\.be\/|v=|embed\/)([^?&\n]+)/); return m?.[1] ?? null; };
...
const MOCK = [
  { id:"m1", linea:"C1", titolo:"C1 – Percorso completo Garibaldi → Capodimonte", tipo:"normale", descrizione:"Percorso standard. Attenzione alla svolta stretta su Via Foria al km 2.", youtubeId:"dQw4w9WgXcQ", routeKey:"C1", routeCoords:[], autore:"Ciro", matricola:"50270", ts:Date.now()-7200000 },
  ...
  { id:"m3", linea:"C31", titolo:"C31 – Piscinola → Pianura completo", tipo:"normale", descrizione:"Tratto integrale. Il tratto Pianura centro è difficile, prestare attenzione alla larghezza.", youtubeId:"3JZ_D3ELwOQ", routeKey:"C31", routeCoords:[], autore:"Ciro", matricola:"50270", ts:Date.now()-86400000 },
    ...
    <div style={{minHeight:"100vh",background:C.bg,display:"flex",alignItems:"center",justifyContent:"center",padding:20,fontFamily:"'Plus Jakarta Sans',sans-serif"}}>
      ...
      <div style={{width:"100%",maxWidth:420}}>
        ...
        <div style={{textAlign:"center",marginTop:24,fontSize:11,color:C.textDim,lineHeight:1.8}}>
          ...
          <div>Sviluppato da <span style={{color:C.textMid}}>Ciro</span> (mat. 50270)</div>
        </div>
      </div>
    </div>
  );
      ...
      <div style={{minHeight:"100vh",background:C.bg}}>
        ...
        <main style={{maxWidth:1140,margin:"0 auto",padding:"24px 20px"}}>
          ...
          <div style={{marginTop:48,paddingTop:18,borderTop:`1px solid ${C.border}`,display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:8,fontSize:11,color:C.textDim}}>
            ...
            <span>💡 Ideato da <span style={{color:C.textMid}}>Guido Tartaglia</span> (mat. 20002) · Sviluppato da <span style={{color:C.textMid}}>Ciro</span> (mat. 50270)</span>
          </div>
        </main>
      </div>
