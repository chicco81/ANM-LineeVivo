        ...
        <header style={{background:C.surface,borderBottom:`1px solid ${C.border}`,position:"sticky",top:0,zIndex:100}}>
          <div style={{maxWidth:1140,margin:"0 auto",padding:"0 20px",display:"flex",alignItems:"center",justifyContent:"space-between",height:62}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <button onClick={()=>requestNotifPermission().then(t=>t?alert("✅ Notifiche attivate! Riceverai avvisi per le deviazioni."):alert("⚠ Notifiche non attivate. Controlla i permessi del browser."))} style={{background:C.surface,border:`1px solid ${C.border}`,color:C.textMid,padding:"6px 13px",borderRadius:8,cursor:"pointer",fontSize:12,fontWeight:600}}>🔔 Notifiche</button>
